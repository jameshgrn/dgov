...
[agent integration]
  ...
  src/dgov/router.py — Model name resolution to backends.
  src/dgov/strategy.py — Routing logic and prompt structuring.
  src/dgov/context_packet.py — Compiled task context.
  src/dgov/preflight.py — Dispatch preflight validation.
...
[decisions]
  src/dgov/decision.py — Typed decision records.
