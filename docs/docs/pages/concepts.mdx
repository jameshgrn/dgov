...
- **Deploy log** — landed-output authority. The deploy log records what
  actually made it onto main. Its append order is the canonical order for
  selecting the newest upstream base ref for dependent worktrees, avoiding
  timestamp-tie ambiguity.
